...
partyRouter.post('/parties', trim.body, tokenAuth.tokenCheck, adminCheck.adminCheck, partyMiddleware.createPartyCheck, createPartyQuery);
...
partyRouter.patch('/parties/:id/name', trim.body, tokenAuth.tokenCheck, adminCheck.adminCheck, partyMiddleware.editSpecificPartyCheck, editPartyQuery);
